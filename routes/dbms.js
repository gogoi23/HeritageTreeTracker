...
//  var password = "Password@123";  //password (change to match your db, yes this is very poor practice)
 
  var host = "143.244.183.215";    //from GCloud instance (change to match your db)
  var database = "USERS";  //database name
  var user = "root";         //username (change to match your db)
  var password = "jantu123";
  //var port = 3306;
